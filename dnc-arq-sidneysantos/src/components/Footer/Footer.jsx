...
import InstagranIcon from '../../assets/instagram-icon.svg'
            ...
            <div className="container">
                ...
                <div className="d-flex jc-space-between footer-copy">
                    ...
                    <div className="langs-area d-flex">
                        <Button buttonStyle='unstyle' onClick={() => changeLanguage('br')}>
                            <img src={BrazilIcon} height="29px" />
                        </Button>
                        <Button buttonStyle='unstyle' onClick={() => changeLanguage('en')}>
